...
VALUES	('SN1', N'Anh Quân Idol, FreakD'),
		...
		('SN6', N'PhongMax'),
		('SN7', N'Lil Zpoet'),
		('SN8', N'Ph?m Nguyên Ng?c, Vanh'),
		('SN9', N'Nguy?n Tr?n Trung Quân, Nguy?n Thýõng, Air'),
		('SN10', N'Tãng Phúc'),
		...
		('SN15', N'Hoài Lâm'),
		('SN16', N'Thành Ð?t'),
		('SN17', N'Soobin Hoàng Sõn'),
		('SN18', N'Hoàng D?ng'),
		('SN19', 'JungKook, JackHarlow'),
		('SN20', 'BRay'),

		('SN21', 'ONEUS'),
		('SN22', N'Tãng Duy Tân, Drum7'),
		('SN23', 'NCT127'),
		('SN24', 'LeagueOfLegends,NewJeans'),
		('SN25', 'DICKSON'),
		('SN26', N'V? Ph?ng Tiên, DT'),
		('SN27', 'MrSiro'),
		('SN28', 'Sean, Freaky'),
		('SN29', 'RichieDICY, Obito'),
		('SN30', N'Tr?nh Ð?nh Quang'),
		...
		('SN35', 'LilWuyn'),
		('SN36', N'BRay, Hoàng Tôn, B?o Hân Helia'),
		('SN37', N'Double2T, H?a Minzy, DýõngK'),
		...
		('SN43', 'BRay,HanSara'),
		('SN44', N'Lê Quyên'),
		('SN45', N'Lýu Ánh Loan, Lê Sang'),
		('SN46', N'Quang Lê'),
		('SN47', N'M?nh Qu?nh, Phi Nhung'),
		('SN48', N'Nhý Qu?nh'),
		('SN49', N'Nhý Qu?nh, M?nh Qu?nh'),
		('SN50', N'Quang Lê, Hýõng Th?y'),
...
('SO02', N'Anh Luôn Nhý V?y', '00:03:32', 'POP',  'assets/img/POP/AnhLuonNhuVay - BRay.png',  'assets/audio/POP/AnhLuonNhuVay - BRay.mp3', 0,'SN20'),
('SO03', N'BailaConmigo', '00:03:04', 'POP',  'assets/img/POP/BailaConmigo - ONEUS.png', 'assets/audio/POP/BailaConmigo - ONEUS.mp3', 0,'SN21'),
('SO04', N'C?t Ðôi N?i S?u', '00:03:02', 'POP',  'assets/img/POP/CatDoiNoiSau - TangDuyTan,Drum7.png', 'assets/audio/POP/CatDoiNoiSau - TangDuyTan,Drum7.mp3', 0,'SN22'),
('SO05', N'E Là Không Th?', '00:05:09', 'POP',  'assets/img/POP/ELaKhongThe - AnhQuanIdol.png', 'assets/audio/POP/ELaKhongThe - AnhQuanIdol.mp3', 0,'SN34'),
...
('SO08', N'Kiêu Ng?o', '00:03:56', 'POP'	,  'assets/img/POP/KieuNgao - DICKSON.png', 'assets/audio/POP/KieuNgao - DICKSON.mp3', 0,'SN25'),
('SO09',N'L? Lýu Ly', '00:03:20', 'POP', 'assets/img/POP/LeLuuLy - VuPhungTien,DT.png', 'assets/audio/POP/LeLuuLy - VuPhungTien,DT.mp3', 0,'SN26'),
('SO10', N'M? Hi?u Con Không', '00:04:58', 'POP',  'assets/img/POP/MeHieuConKhong - MrSiro.png',  'assets/audio/POP/MeHieuConKhong - MrSiro.mp3', 0,'SN27'),
...
('SO18', N'Anh T? Do Nhýng Cô Ðõn',  '00:04:52', 'POP',  'assets/img/POP/AnhTuDoNhungCoDon - DatG.png', 'assets/audio/POP/AnhTuDoNhungCoDon - DatG.mp3', 0,'SN12'),
('SO19', 'Bigcityboi',  '00:03:21', 'POP',  'assets/img/POP/Bigcityboi - Binz.png', 'assets/audio/POP/Bigcityboi - Binz.mp3', 0,'SN13'),
('SO20', N'Hoa N? Không Màu',  '00:05:28', 'POP',  'assets/img/POP/HoaNoKhongMau - HoaiLam.png','assets/audio/POP/HoaNoKhongMau - HoaiLam.mp3', 0,'SN14'),		
...
('SO22', N'Ngày Mai Em Ði M?t',  '00:04:09', 'POP',  'assets/img/POP/NgayMaiEmDiMat - DatG.png', 'assets/audio/POP/NgayMaiEmDiMat - DatG.mp3', 0,'SN12'),
('SO23', N'Ngày Mai Ngý?i Ta L?y Ch?ng',  '00:06:01', 'POP', 'assets/img/POP/NgayMaiNguoiTaLayChong - ThanhDat.png', 'assets/audio/POP/NgayMaiNguoiTaLayChong - ThanhDat.mp3', 0,'SN16'),
('SO24', N'Nhý Nh?ng Phút Ban Ð?u',  '00:05:34', 'POP',  'assets/img/POP/NhuNhungPhutBanDau - HoaiLam.png', 'assets/audio/POP/NhuNhungPhutBanDau - HoaiLam.mp3', 0,'SN15'),
('SO25', N'Tháng Nãm',  '00:03:01', 'POP',  'assets/img/POP/ThangNam - SoobinHoangSon.png', 'assets/audio/POP/ThangNam - SoobinHoangSon.mp3', 0,'SN17'),
('SO26', N'Nàng Thõ',  '00:04:14', 'POP',  'assets/img/Lofi Chill/NangTho - HoangDung.png', 'assets/audio/Lofi Chill/NangTho - HoangDung.mp3', 0,'SN18'),
...
('SO28', N'Bông Hoa Ch?ng Thu?c V? Ta',  '00:03:36', 'Lofi Chill',  'assets/img/Lofi Chill/BongHoaChangThuocVeTa - NhuViet.png', 'assets/audio/Lofi Chill/BongHoaChangThuocVeTa - NhuViet.mp3', 0,'SN2'),
('SO29', N'Chuy?n Ðôi Ta',  '00:03:28', 'Lofi Chill',  'assets/img/Lofi Chill/ChuyenDoiTa - EmceeL,Muoii.png', 'assets/audio/Lofi Chill/ChuyenDoiTa - EmceeL,Muoii.mp3', 0,'SN3'),	
('SO30', N'AN',  '00:03:09','Rap',  'assets/img/Rap/AN - LilWuyn.png', 'assets/audio/Rap/AN - LilWuyn.mp3', 0,'SN35'),

('SO31', N'Em B? Hút Thu?c Chýa',  '00:03:36', 'Lofi Chill',  'assets/img/Lofi Chill/EmBoHutThuocChua - BichPhuong.png', 'assets/audio/Lofi Chill/EmBoHutThuocChua - BichPhuong.mp3', 0,'SN4'),
...
('SO34', N'K? Ðiên Tin Vào T?nh Yêu',  '00:04:36', 'Lofi Chill',  'assets/img/Lofi Chill/KeDienTinVaoTinhYeu - LilZ.png', 'assets/audio/Lofi Chill/KeDienTinVaoTinhYeu - LilZ.mp3', 0,'SN7'),
...
('SO36', N'Ngý?i V? Týõng Lai Mõ M?ng',  '00:02:41', 'Lofi Chill',  'assets/img/Lofi Chill/NguoiVeTuongLaiMoMong - NguyenTranTrungQuan,NguyenThuong,Air.png', 'assets/audio/Lofi Chill/NguoiVeTuongLaiMoMong - NguyenTranTrungQuan,NguyenThuong,Air.mp3', 0,'SN9'),
...
('SO38', N'Bí M?t Nh?',  '00:03:53','Rap',  'assets/img/Rap/BiMatNho - BRay,HoangTon,BaoHanHelia.png', 'assets/audio/Rap/BiMatNho - BRay,HoangTon,BaoHanHelia.mp3', 0,'SN36'),
('SO39', N'Chài Ði?p No?ng',  '00:04:18','Rap',  'assets/img/Rap/ChaiDiepNoong -  Double2T,HoaMinzy,DuongK.png', 'assets/audio/Rap/ChaiDiepNoong -  Double2T,HoaMinzy,DuongK.mp3', 0,'SN37'),
('SO40', N'Chõi Nhý T?i M?',  '00:02:40','Rap',  'assets/img/Rap/ChoiNhuTuiMy - AndreeRightHand.png', 'assets/audio/Rap/ChoiNhuTuiMy - AndreeRightHand.mp3', 0,'SN38'),

('SO41', N'Con Trai Cýng',  '00:02:38','Rap',  'assets/img/Rap/ConTraiCung - BRay,Masew.png', 'assets/audio/Rap/ConTraiCung - BRay,Masew.mp3', 0,'SN52'),
...
('SO45', N'Xin Ð?ng Nh?c Máy',  '00:03:07','Rap',  'assets/img/Rap/XinDungNhacMay - BRay,HanSara.png', 'assets/audio/Rap/XinDungNhacMay - BRay,HanSara.mp3', 0,'SN43'),
...
('SO47', N'Con Ðý?ng Xýa Em Ði',  '00:04:46', 'Ballad',  'assets/img/Ballad/ConDuongXuaEmDi - LuuAnhLoan,LeSang.png', 'assets/audio/Ballad/ConDuongXuaEmDi - LuuAnhLoan,LeSang.mp3', 0,'SN45'),
('SO48', N'Ð?p V? Cây Ðàn',  '00:05:03', 'Ballad',  'assets/img/Ballad/DapVoCayDan - QuangLe.png', 'assets/audio/Ballad/DapVoCayDan - QuangLe.mp3', 0,'SN46'),
('SO49', N'Gi? Th? Ai Cý?i', '00:03:16','Rap',  'assets/img/Rap/GioThiAiCuoi - HIEUTHUHAI,Kewtiie.png', 'assets/audio/Rap/GioThiAiCuoi - HIEUTHUHAI,Kewtiie.mp3', 0,'SN40'),
('SO50', N'Ð?ng Nói Xa Nhau',  '00:08:00', 'Ballad',  'assets/img/Ballad/DungNoiXaNhau - ManhQuynh,PhiNhung.png', 'assets/audio/Ballad/DungNoiXaNhau - ManhQuynh,PhiNhung.mp3', 0,'SN47'),

('SO51', N'Duyên Ph?n',  '00:05:44', 'Ballad',  'assets/img/Ballad/DuyenPhan - NhuQuynh.png', 'assets/audio/Ballad/DuyenPhan - NhuQuynh.mp3', 0,'SN48'),
('SO52', N'N?i L?i T?nh Xýa',  '00:04:35', 'Ballad',  'assets/img/Ballad/NoiLaiTinhXua - NhuQuynh,ManhQuynh.png', 'assets/audio/Ballad/NoiLaiTinhXua - NhuQuynh,ManhQuynh.mp3', 0,'SN49'),
('SO53', N'T?nh Nh? Mau Quên', '00:04:47', 'Ballad',  'assets/img/Ballad/TinhNhoMauQuen - QuangLe,HuongThuy.png', 'assets/audio/Ballad/TinhNhoMauQuen - QuangLe,HuongThuy.mp3', 0,'SN50'),
('SO54', N'Trách Ai Vô T?nh', '00:04:38', 'Ballad',  'assets/img/Ballad/TrachAiVoTinh - PhiNhung.png', 'assets/audio/Ballad/TrachAiVoTinh - PhiNhung.mp3', 0,'SN51'),
