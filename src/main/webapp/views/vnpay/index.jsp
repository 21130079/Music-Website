...
<html lang="en">
    <head>
        ...
        <link href="/MusicWebsite/assets/css/jumbotron-narrow.css" rel="stylesheet">      
    ...
    <body>
        ...
        <script>
             function pay() {
              window.location.href = "/MusicWebsite/views/vnpay/vnpay_pay.jsp";
            }
            function querydr() {
              window.location.href = "/MusicWebsite/views/vnpay/vnpay_querydr.jsp";
            }
             function refund() {
              window.location.href = "/MusicWebsite/views/vnpay/vnpay_refund.jsp";
            }
        </script>
    </body>
</html>
