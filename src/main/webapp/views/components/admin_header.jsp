					...
					<table>
						<tr>
							...
							<td style="padding-left: 10px"><b><a
									class="song_admin nav-link"
									href="/MusicWebsite/views/admin/admin.jsp">Song</a></b></td>
							<td style="padding-left: 10px"><b> <a
									class="log_admin nav-link"
									href="/MusicWebsite/views/admin/admin_account.jsp">Accoint</a></b></td>
							<td style="padding-left: 10px"><b> <a
									class="log_admin nav-link"
