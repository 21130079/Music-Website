				...
				<header id="header">
					<div class="logo">
						<a href="/MusicWebsite/index.jsp" class="img-logo"> <img
								src="/MusicWebsite/assets/img/Other/logo.png" alt="" style="height: 171px;">
						</a>
					</div>
					<div class="col-9">
						<ul class="nav">
					...
					<div class="search-box">
						<form action="/MusicWebsite/SearchController" method="get" style="margin-left:-230px;">
							...
							<input type="text" class="input-search" oninput="searchByName(this)"
								onblur="appearImg(this)" placeholder="Search by name..." name="searchInput">
						</form>
					</div>
					<div class="sign-in">
						<c:choose>
							<c:when test="${sessionScope.account!=null}">
								<jsp:useBean id="daoNotification" class="database.DAONotification" scope="session">
								</jsp:useBean>
												...
												<c:when test="${listNotifications[i].levelNotification=='ALERT' }">
													<div class="notification-item" style="background-color: orange;">
														<p class="notification-item-content">
															${listNotifications[i].username }:
															${listNotifications[i].descript }</p>
									...
									<div class="wrapper">
										...
										<div class="form-wrapper">
											<form action="/MusicWebsite/NewPasswordController" method="post">
												...
												<div style="color: red; margin-top: ${formatPass};">${messageOldPass}
												</div>
												<div class="input-group">
													<input type="password" required name="newPass"> <label for="">New
														password</label>
												</div>
												<div style="color: red; margin-top: ${formatPass};">${messageNewPass}
												</div>
							...
							<div id="login" class="body-log" style="display:${display};">
								...
								<div class="wrapper">
									...
									<div class="form-wrapper sign-up">
										<form action="/MusicWebsite/SignUpController" method="post">
    										...
    										&client_id=635263821596-utj1bf1e28i9jcc36vsampol1hbj4gmv.apps.googleusercontent.com&approval_prompt=force"
													class=gg-icon> <svg xmlns="http://www.w3.org/2000/svg" x="0px"
									...
									<div class="form-wrapper sign-in">
										...
										<form action=<c:url value="/LoginController">
											</c:url>
											method="post">
